...
final class DialogOptions {
    ...
    private int titleResId = R.string.new_rate_dialog_title;

    private int messageResId = R.string.new_rate_dialog_message;

    private int textPositiveResId = R.string.new_rate_dialog_ok;

    private int textNeutralResId = R.string.new_rate_dialog_later;

    private int textNegativeResId = R.string.new_rate_dialog_never;
