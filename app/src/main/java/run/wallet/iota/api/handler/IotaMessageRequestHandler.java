...
public abstract class IotaMessageRequestHandler implements RequestHandler {
    final RunIotaAPI apiProxy;
    final Context context;

    IotaMessageRequestHandler(RunIotaAPI iotaApi, Context context) {
