...
public class RefreshUsedAddressesRequest extends SeedApiRequest {
    ...
    public RefreshUsedAddressesRequest(Seeds.Seed seed) {

        super(seed);
    }
    public RefreshUsedAddressesRequest(Seeds.Seed seed, boolean force) {
